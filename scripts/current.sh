...
#./scripts/test.sh MLARAM _ mlaram ${data[*]} 8
./scripts/test.sh MLkNN _ mlknn ${data[*]} 8
#./scripts/test.sh BRkNNaClassifier _ brknna ${data[*]} 8
#./scripts/test.sh BRkNNbClassifier _ brknnb ${data[*]} 8
